...
describe('Card de temperatura', () => {
  it('Deve renderizar o card com as informações passadas por props', () => {
    const { getByText, queryByText } = render(<Card temp="32" city="Curitiba" country="PR" temperature={17} humidity={65} pressure={856} updatedAt="25:65:45" />)
    ...
    expect(getByText('Updated at 25:65:45 PM'))
  })
  
  it('Não deve encontrar informações "humidity" e "pressure"', () => {
    const { getByText, queryByText } = render(<Card temp="32" city="Curitiba" country="PR" temperature={17} updatedAt="25:65:45" />)
